...
//版面内容
$sql='select intro,content from pageset WHERE id_pageset = 3';
...
//活动
$sql='select id_newsinfo,title,intro,content from newsinfo WHERE id_newsinfo ='.$_GET["id"];
$event= $db->queryOne($sql);
