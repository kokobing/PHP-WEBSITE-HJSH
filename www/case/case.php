...
<!DOCTYPE html>
    ...
    <div class="all">
        ...
        <div class="innerpage caseinnerpage">
            <div class="content">

                <div class="title"><strong><?php echo $pageinfo['title'];?></strong></div>
                <div class="info">
            ...
            <div class="right">
                ...
                <div class="menulist"><a href="#" class="act"  title="<?php echo $pageinfo['pagetag'];?>"><?php echo $pageinfo['title'];?></a></div>
