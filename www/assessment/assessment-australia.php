...
<!DOCTYPE html>
    ...
    <div class="all">
        ...
        <div class="innerpage caseinnerpage pg">
            <div class="content">
                ...
                <div class="title"><strong><i class="fa fa-bar-chart" aria-hidden="true"></i> 澳洲移民评估系统 </strong>
                ...
                <div class="info">
                    ...
                    <div class="infointro">
                        ...
                        <div class="infointroright">
                            ...
                            <input type="radio" value="18-50岁" name="year"> 18-50岁&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" value="50-55岁" name="year"> 50-55岁&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" value=">55岁" name="year"> >55岁&nbsp;&nbsp;&nbsp;&nbsp;
                        </div>
                    ...
                    <div class="infointro">
                        ...
                        <div class="infointroright">
                            <input type="radio" value="无" name="education"> 无&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" value="中技或高中" name="education"> 中技或高中&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" value="大专" name="education"> 大专&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" value="本科" name="education"> 本科&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <div class="infointro">
                        ...
                        <div class="infointroright">
                            ...
                            <input type="radio" value="≥3年" name="work"> ≥3年&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <div class="infotitle"></div>
                    <div class="infointro">
                        <div class="infointroleft">持有股份情况 </div>
                        <div class="infointroright">
                            <input type="radio" value="持股不足30%，或者不足2年" name="shareholdings"> 持股不足30%，或者不足2年&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" value="≥30%，且满足持股2年以上，价值＜200万RMB" name="shareholdings"> ≥30%，且满足持股2年以上，价值＜200万RMB &nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" value="≥30%，且足持股2年以上，价值≥200万RMB" name="shareholdings"> ≥30%，且足持股2年以上，价值≥200万RMB&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <div class="infotitle"></div>
                    <div class="infointro">
                        <div class="infointroleft">公司年营业额 </div>
                        <div class="infointroright">
                            <input type="radio" value="<250万RMB" name="company"> <250万RMB&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" value="250-1500RMB" name="company"> 250-1500RMB&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" value="≥1500万RMB" name="company"> ≥1500万RMB&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <div class="infointro">
                        ...
                        <div class="infointroright">
                            <input type="radio" value="<400万RMB" name="assets"> <400万RMB&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" value="400-800万RMB" name="assets"> 400-800万RMB&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" value="800-3000万RMB" name="assets"> 800-3000万RMB&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" value="≥3000万RMB" name="assets"> ≥3000万RMB&nbsp;&nbsp;&nbsp;&nbsp;
                        </div>
            ...
            <div class="right" style="margin-top:25px;">
                ...
                <div class="menulist"><a href="/assessment/assessment.html" class="actother">加拿大移民评估</a></div>
                <div class="menulist"><a href="/assessment/assessment-australia.php" class="actother"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> 澳洲移民评估</a></div>
    ...
    <script>
        ...
        $('#btnpg').click(function(){
            ...
            var shareholdings=$("input[name='shareholdings']:checked").val();
            ...
            $.post('/inc/ajax_australia.php',{year:year,education:education,ielts:ielts,work:work,assets:assets,name:name,mobi:mobi,company:company,shareholdings:shareholdings},function(data){
