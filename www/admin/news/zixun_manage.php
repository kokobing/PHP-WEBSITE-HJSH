...
if(isset($action) && ($action=="" || substr($action,0,14)=='&searchselect=')){
    ...
    $strSQL = "SELECT newsinfo.id_newsinfo,newsinfo.indate,newsdir.name,newsinfo.newsdate,newsinfo.title,newsinfo.content,newsinfo.ordernum,newsinfo.id_newsdir,newsdir.lang,newsdir.fatherid FROM newsinfo left join newsdir on newsinfo.id_newsdir=newsdir.id_newsdir WHERE newsinfo.dele='1'  and (newsinfo.id_newsdir='13') $str order by newsinfo.indate DESC" ;
...
<!--                        --><?php //}?>
            ...
            <?php if(isset($action)  && ($action=="" || substr($action,0,14)=='&searchselect=')){?>
                <div id="lineout">
                        ...
                        <tr>
                            <td width="77%" height="36" align="left" background="../inc/pics/lanmubg.gif"><table width="200" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td width="153" class="txt_lanmu">移民评估库</td>
                                    </tr>
                                </table></td>
                            <td width="23%" align="center" background="../inc/pics/lanmubg.gif"  class="txt">每页显示 <a href="zixun_manageprint.php?Rows=5" class="link_rightmenu">5</a> <a href="zixun_manageprint.php?Rows=10"  class="link_rightmenu">10</a> <a href="zixun_manageprint.php?Rows=15" class="link_rightmenu">15</a> <a href="zixun_manageprint.php?Rows=20" class="link_rightmenu">20</a> <a href="zixun_manageprint.php?Rows=25" class="link_rightmenu">25</a> <a href="zixun_manageprint.php?Rows=30" class="link_rightmenu">30</a></td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                        </tr>
				    ...
				    <a href="zixun_manageprint.php?&searchselect=<?php echo $arr2dirsearch2[$i][id_newsdir];?>" <? if($_GET[searchselect]==$arr2dirsearch2[$i][id_newsdir]){echo 'class="link_dir2s"';}else{echo 'class="link_dir2"';}?> ><?php echo $arr2dirsearch2[$i][name];?></a> <span class="txt_footer">|</span>
				<?php }?>
                <br>
                <?php for($i=0;$i<sizeof($arr2dirsearch);$i++){?>
				    <a href="zixun_manageprint.php?&searchselect=<?php echo $arr2dirsearch[$i][id_newsdir];?>" <? if($_GET[searchselect]==$arr2dirsearch[$i][id_newsdir]){echo 'class="link_dir2s"';}else{echo 'class="link_dir2"';}?> ><?php echo $arr2dirsearch[$i][name];?></a> <span class="txt_footer">|</span>
				<?php }?>
                 --><br>
                                        </td>
                                    </tr>
                                        ...
                                        <tr>
                                            <td height="30" align="left" valign="bottom" class="txt_leftmenu">
                                                <table width="100%" border="0" cellspacing="5" cellpadding="3">
                                                    <tr>
                                                        <td align="left" width="15%" class="txt_leftmenu">[ <?php //echo $dir1name[name]?> <?php echo $arrnewsinfos[$i][name]?> ]</td>
                                                        <td width="20%" align="left" class="txt_leftmenu">[ <?php echo $arrnewsinfos[$i][indate]?> ]</td>
                                                        <td width="40%" align="left"><a href="zixun_manageprint.php?03<?php echo $arrnewsinfos[$i][id_newsinfo];?>&searchselect=<?php echo $searchselect;?>&searchdate=<?php echo $searchdate;?>&keywords=<?php echo $keywords;?>"  class="txt_leftmenu"  target="_blank"><?php echo cutstr($arrnewsinfos[$i][title],60,1);?></a></td>
                                                        ...
                                                        <td width="5%" align="right">
                                                            <? if($i!=0){ //判断一级目录是否位置在最前?>
                                                                <a href='zixun_manageprint.php?action=switch&id=<?=$arrnewsinfos[$i][id_newsinfo];?>&order=<?=$arrnewsinfos[$i][ordernum];?>&swtid=<?=$arrnewsinfos[$i-1][id_newsinfo];?>&swtorder=<?=$arrnewsinfos[$i-1][ordernum];?>&page=<?=$_GET[page];?>&searchselect=<?=$_GET[searchselect];?>'><img src='../inc/pics/icon_001.gif' border='0' width='10' height='10'></a>&nbsp;
                                                            <? }else {?>
                                                                <img src='../inc/pics/icon_0012.gif' border='0' width='10' height='10'>&nbsp;

                                                            <? } if($i!=$intNews-1){//判断一级目录是否位置在最后?>
                                                                <a href='zixun_manageprint.php?action=switch&id=<?=$arrnewsinfos[$i][id_newsinfo];?>&order=<?=$arrnewsinfos[$i][ordernum];?>&swtid=<?=$arrnewsinfos[$i+1][id_newsinfo];?>&swtorder=<?=$arrnewsinfos[$i+1][ordernum];?>&page=<?=$_GET[page];?>&searchselect=<?=$_GET[searchselect];?>'><img src='../inc/pics/icon_002.gif' border='0' width='10' height='10'></a>&nbsp;
                                                            <? } else{ ?>
                        ...
                        <tr>
                            <td height="36" align="left" background="../inc/pics/lanmubg.gif"><table width="200" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="32">&nbsp;</td>
                                        <td width="15"><img src="../inc/pics/lm_icon.gif" width="10" height="7"></td>
                                        <td width="153" class="txt_lanmu"><a href="zixun_manageprint.php?03<?php echo $onenewsinfo[id_newsinfo];?>" class="txt_lanmu" style="text-decoration: none;" target="_blank">打印信息<a/></td>
                                    </tr>
                                </table></td>
                        </tr>
                        <tr>
                                                ...
                                                <table width="100%" border="0" cellpadding="4" cellspacing="0" class="txt">
                                                    ...
                                                    <tr bgcolor="#FFFFFF">
                                                        ...
                                                        <td bgcolor="#FFFFFF">
                                                            ...
                                                            <input class="btn" type="button" name="button_back2" id="button_back2" value="返回" onclick="javascript:location.href='zixun_manageprint.php?&searchselect=<?php echo $searchselect;?>&searchdate=<?php echo $searchdate;?>&keywords=<?php echo $keywords;?>'" />
