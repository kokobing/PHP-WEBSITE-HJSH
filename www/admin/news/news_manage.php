...
//输出一级目录  
  $strSQL="SELECT id_newsdir,name FROM newsdir where dele='1' and level='1' and  (id_newsdir='1' or id_newsdir='5'    or id_newsdir='55'  or id_newsdir='59'  or id_newsdir='63' or id_newsdir='67'  or id_newsdir='71'  or id_newsdir='75' ) ";
  $objDB->Execute($strSQL);
...
$strSQLNum = "SELECT COUNT(*) as num from newsinfo left join newsdir on newsinfo.id_newsdir=newsdir.id_newsdir WHERE newsinfo.dele='1'  and (newsdir.fatherid='1' or newsdir.fatherid='5'  or newsdir.fatherid='55' or newsdir.fatherid='59' or newsdir.fatherid='63' or newsdir.fatherid='67' or newsdir.fatherid='71' or newsdir.fatherid='75') $str";
...
$strSQL = "SELECT newsinfo.id_newsinfo,newsdir.name,newsinfo.newsdate,newsinfo.title,newsinfo.content,newsinfo.ordernum,newsinfo.id_newsdir,newsdir.lang,newsdir.fatherid  FROM newsinfo left join newsdir on newsinfo.id_newsdir=newsdir.id_newsdir WHERE newsinfo.dele='1'  and (newsdir.fatherid='1' or newsdir.fatherid='5'  or newsdir.fatherid='55' or newsdir.fatherid='59' or newsdir.fatherid='63' or newsdir.fatherid='67' or newsdir.fatherid='71' or newsdir.fatherid='75') $str order by newsinfo.ordernum DESC" ;
...
if(isset($action) && substr($action,0,2)=="04" && $onuserperm_editprem=='1'){
    ...
    $strSQL="UPDATE newsinfo SET title='$newstitle',content='$newscontent',id_newsdir='$select2',url='$url',newsdate='$fbtime',modate=now(),intro='$newsintro',tag='$newstag',pagetitle='$pagetitle',pagekey='$pagekey',pagetag='$pagetag',pagedesc='$pagedesc' where id_newsinfo=$onenewsinfoid";
	$objDB->Execute($strSQL);
            ...
            <tr>
              ...
              <table width="100%" border="0" cellspacing="5" cellpadding="3">
                  <tr>
                    ...
                    <td width="40%" align="left"><a href="news_manage.php?03<?php echo $arrnewsinfos[$i][id_newsinfo];?>&searchselect=<?php echo $searchselect;?>&searchdate=<?php echo $searchdate;?>&keywords=<?php echo $keywords;?>"  class="txt_leftmenu"><?php echo cutstr($arrnewsinfos[$i][title],60,1);?></a></td>
            ...
            <tr>
              ...
              <table width="100%" border="0" cellpadding="4" cellspacing="0" class="txt">
                  <tr bgcolor="#FFFFFF">
                      ...
                      <td bgcolor="#FFFFFF"><?php //echo $siteurl;?>/news/news-<?php echo $onenewsinfo[id_newsinfo];?>.html</td>
                  ...
                  <tr bgcolor="#FFFFFF">
                      ...
                      <td bgcolor="#FFFFFF">
                          <input name="pagetitle" type="text" class="input_01" id="pagetitle" style="width:400px" value="<?php echo $onenewsinfo[pagetitle];?>" />
                          （SEO自定义页面标题title）
                  </tr>
                  ...
                  <tr bgcolor="#FFFFFF">
                      ...
                      <td bgcolor="#FFFFFF">
                          <input name="pagekey" type="text" class="input_01" id="keywords" style="width:400px" value="<?php echo $onenewsinfo[pagekey];?>" />
                          （SEO关健词全局设定），关健词用“,”分隔
                  </tr>
                  ...
                  <tr bgcolor="#FFFFFF">
                      ...
                      <td bgcolor="#FFFFFF">
                          <input name="pagetag" type="text" class="input_01" id="pagetag" style="width:400px" value="<?php echo $onenewsinfo[pagetag];?>" />
                          （SEO页面标签全局设定），关健词用“,”分隔
                      </td>
                  </tr>
                  ...
                  <tr bgcolor="#FFFFFF">
                      ...
                      <td bgcolor="#FFFFFF"  valign="top">
                          <textarea name="pagedesc" rows="5" class="input_01" id="intro" style="width:400px"><?php echo $onenewsinfo[pagedesc];?></textarea>
                          （SEO描述设定），页面描述
                      </td>
                  </tr>
                  <tr>
