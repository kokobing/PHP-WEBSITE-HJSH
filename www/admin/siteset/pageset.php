...
if(isset($action) && $action=="02" && $onuserperm_addprem=='1'){
	...
	$strSQL="INSERT INTO pageset(title,pagetitle,keywords,description,content,intro,lang,location,pagetag)
	                     values('".$_POST[title]."','".$_POST[pagetitle]."','".$_POST[keywords]."','".$_POST[description]."','".$_POST[newscontent]."','".$_POST[intro]."','".$_POST[lang]."','".$_POST[location]."','".$_POST[pagetag]."')";
	$objDB->Execute($strSQL);
...
if(isset($action) && substr($action,0,2)=="04" && $onuserperm_editprem=='1'){
    ...
    $strSQL="UPDATE pageset SET title='".$_POST[title]."',pagetitle='".$_POST[pagetitle]."',keywords='".$_POST[keywords]."',description='".$_POST[description]."',content='".$_POST[newscontent]."',intro='".$_POST[intro]."',lang='".$_POST[lang]."',location='".$_POST[location]."',pagetag='".$_POST[pagetag]."' where id_pageset=$onenewsinfoid";
	$objDB->Execute($strSQL);
        ...
        <tr>
          <td align="center"><table width="95%" border="0" cellspacing="0" cellpadding="5">
            ...
            <tr>
              ...
              <td width="30%" align="left" valign="bottom" class="txt_3"><span class="txt_3">
               <?php echo $arrnewsinfos[$i][intro];?>
              </span></td>
              
              <td width="33%" align="left" valign="bottom" class="txt_leftmenu">&nbsp;</td>
            ...
            <tr>
              ...
              <table width="100%" border="0" cellpadding="4" cellspacing="0" class="txt">
                  <tr bgcolor="#FFFFFF">
                    ...
                    <td bgcolor="#FFFFFF">
                        <input name="pagetitle" type="text" class="input_01" id="pagetitle" style="width:400px" value="" />
                        （SEO自定义页面标题title）
                      </tr>
                  <tr>
                      <td colspan="3" align="left" valign="middle" bgcolor="#EBF3F9"  style="padding:0; height:1px;"></td>
                  ...
                  <tr bgcolor="#FFFFFF">
                    ...
                    <td bgcolor="#FFFFFF">
                        <input name="keywords" type="text" class="input_01" id="keywords" style="width:400px" value="" />
                        （SEO关健词全局设定），关健词用“,”分隔
                      </tr>
                  <tr>
                      <td colspan="3" align="left" valign="middle" bgcolor="#EBF3F9"  style="padding:0; height:1px;"></td>
                  ...
                  <tr bgcolor="#FFFFFF">
                      ...
                      <td bgcolor="#FFFFFF">
                          <input name="pagetag" type="text" class="input_01" id="pagetag" style="width:400px" value="" />
                          （SEO页面标签全局设定），关健词用“,”分隔
                      </td>
                  </tr>
                                    <tr>
                  ...
                  <tr bgcolor="#FFFFFF">
                    ...
                    <td bgcolor="#FFFFFF"  valign="top">
                        <textarea name="description" rows="5" class="input_01" id="intro" style="width:400px"></textarea>
                        （SEO描述设定），页面描述
                    </td>
                      </tr>
                  <tr>
                  ...
                  <tr bgcolor="#FFFFFF">
                    <td valign="top" bgcolor="#FFFFFF">版面简介</td>
